...
def generate_dataset():
    ...
    for i in range(0, number_of_patients):
        ...
        for j in range(0, len(clinical_data)):
            ...
            data.append([rec_num, name_given, name_father, name_fathers_father, name_mother, name_mothers_father,
                         gender, dob, town_region[1], phone_number, clinical_data[j]])
    df = pd.DataFrame(data, columns=['rec_num', 'name_given', 'name_father', 'name_fathers_father', 'name_mother',
